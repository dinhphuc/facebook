...
<head>
    ...
    <!-- Page title -->
    <title>kBz | Bot Cảm Xúc Chất Nhất Việt Nam</title>
        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <form class="navbar-form navbar-left">
                    <input type="text" class="form-control" placeholder="Bot Cảm Xúc - VuTienAnh.Pro" style="width: 175px">
                </form>
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class=" profil-link">
                        <a href="login.html">
                            <span class="profile-address">xnxx</span>
                            <img src="https://graph.fb.me/100009580369715/picture" class="img-circle" alt="">
                        </a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            <div class="pull-right text-right" style="line-height: 14px">
                                <small>kBz<br>Dashboard<br> <span class="c-white">v.3.0</span></small>
                            </div>
                            <div class="header-icon">
                                <i class="pe page-header-icon pe-7s-shield"></i>
                            </div>
                            <div class="header-title">
                                <h3 class="m-b-xs">VuTienAnh.Pro</h3>
                                <small>
...
<?php if(!$_SESSION[id])
{
    ?>
                    ...
                    <div class="panel panel-filled">
						...
						<p> Nếu Bạn Sử Dụng <code> kBz</code> Trên Điện Thoại Và Không Lấy Được Cookie  ? <p>
                ...
                <div class="col-md-12">
                    <div class="panel panel-filled">
                        ...
                        <div class="panel-body">
                            ...
                            <p><div class="embed-responsive embed-responsive-16by9"><iframe width="360" height="115" src="https://www.youtube.com/embed/u8GTxf-xBLQ?autoplay=0" frameborder="0" allowfullscreen></iframe></div></p>
