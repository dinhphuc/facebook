<?php  
$res = @mysqli_query($connection, "SELECT * FROM `bottuongtac` WHERE `idfb`= $_SESSION[idfb]");
...
<div class="col-md-12">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-comments" aria-hidden="true"></i> Bot Tương Tác - Robot Tự Comment Tương Tác</h4>
		...
		<div class="box-body">
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="bottuongtac" onclick="post_BotTuongTac();">
