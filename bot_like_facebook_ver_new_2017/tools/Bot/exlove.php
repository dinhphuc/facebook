<?php  
$res = @mysqli_query($connection, "SELECT * FROM `botexlove` WHERE `idfb`= '".$_SESSION[idfb]."'");
...
<div class="col-md-12">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up" aria-hidden="true"></i> Bot Exchange Love - Trao Đổi Cảm Xúc Love</h4>
		...
		<div class="box-body">
			...
			<div class="alert alert-warning" style="background-color: rgba(245, 215, 66, 0.32); border-color: rgba(245, 215, 66, 0.32);">
				<span style="color: black; font-size: 15px;"><i class="fa fa-reddit-square"></i> Bot EX Love Status, Ảnh : <font color ="red"><?php echo ($key == 1) ? "Hoạt Động" : "Không Sử Dụng";?> </font></span><br />
                    			<span style="color: black; font-size: 15px;"><i class="fa fa-reddit-square"></i> Bot EX Love Comment : <font color ="red"><?php echo $getcmt[likecmt] == 1 ? "Hoạt Động " : "Không Sử Dụng"; ?></font></span>
			</div>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="botexlove" onclick="post_BotExLove();">
