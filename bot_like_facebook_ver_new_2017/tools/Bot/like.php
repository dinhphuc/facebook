<?php  
$res = @mysqli_query($connection, "SELECT * FROM `botlike` WHERE `idfb`= '".$_SESSION[idfb]."'");
	...
	<div class="box box-success">
		...
		<div class="box-body">
			...
			<div class="alert alert-warning" style="background-color: rgba(245, 215, 66, 0.32); border-color: rgba(245, 215, 66, 0.32);">
				<span style="color: black; font-size: 15px;"><i class="fa fa-reddit-square"></i> Bot Like Status, Ảnh : <font color ="red"><?php echo ($key == 1) ? "Hoạt Động" : "Không Sử Dụng";?> </font></span><br />
                    			<span style="color: black; font-size: 15px;"><i class="fa fa-reddit-square"></i> Bot Like Comment : <font color ="red"><?php echo $getcmt[likecmt] == 1 ? "Hoạt Động " : "Không Sử Dụng"; ?></font></span>
			</div>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="botlike" onclick="post_BotLike();">
