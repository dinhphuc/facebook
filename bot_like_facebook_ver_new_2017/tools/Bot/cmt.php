<?php  
$res = @mysqli_query($connection, "SELECT * FROM `botcmt` WHERE `idfb`= $_SESSION[idfb]");
...
<div class="col-md-12">
	<div class="box box-success">
		...
		<div class="box-body">
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
					<select id="bieutuong" name="bieutuong" style="color: black; font-size: 15px;" class="form-control">
						<option value="1">ON - Bật Chèn Biểu Tượng</option>	
						<option value="0">OFF - Tắt Chèn Biểu Tượng</option>								
					</select>
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
			</div><br />
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
					<select id="quangcao" name="quangcao" style="color: black; font-size: 15px;" class="form-control">
						<option value="1">ON - Bật Quảng Cáo</option>	
						<option value="0">OFF - Tắt Quảng Cáo</option>								
					</select>
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
			</div><br />
