<?php  
$res = @mysqli_query($connection, "SELECT * FROM `siminboxcanhan` WHERE `idfb`= '".$_SESSION['idfb']."'");
...
<div class="col-md-12">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-reddit" aria-hidden="true"></i> Bot Simsimi Inbox Trang Cá Nhân - Robot Trả Lời Simsimi</h4>
		...
		<div class="box-body">
			<div class="alert alert-info" style="font-size: 15px; background-color: rgba(157, 248, 89, 0.62); border-color: rgba(157, 248, 89, 0.62);">
				...
				<b style="font-color:red;">Lưu Ý:</b> Bạn Phải Đăng Nhập Bằng Tài Khoản Facebook và Chọn App "Token For iPhone" Ở  <code><a href="/index.html" target="_blank"><font color=red> Đăng Nhập Hệ Thống</font></a></code><br /> Mới Dùng Được Chức Năng Này<br>
			</div>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="siminboxcanhan" onclick="post_SimInboxCanhan();">
