<div class="col-md-5">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Auto Share - Tăng Lượt Chia Sẻ Tự Động</h4>
			
		</div>
		<div class="box-body">
			<h4><strong><p class="text-danger"> Hệ Thống Tăng Lượt Chia Sẻ Facebook Theo ID Bất Kỳ</p></strong></h4>
			<font style="color:#23c6c8;">Bước 1:</font> Sử Dụng Mục Bên " Trạng Thái - Gần Đây" Để Copy ID Status, Ảnh, Video Của Bạn. Có Thể Sử Dụng ID Người Khác Để Tăng Like. <br />
			<font style="color:#23c6c8;">Bước 2:</font> Nhập ID Vào Khung Bên Dưới Sau Đó Thực Hiện Auto Share. <br />
			...
			<div class="form-group">
				<label for="name">Chọn Số Lượng Share - Kéo Thanh Trượt Để Điều Chỉnh</label>
				<center>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="share" onclick="post_Share();">
					<i class="fa fa-exchange"></i> Auto Chia Sẻ
				</button>
			</div>
		</div>
		<div class="box-footer">
			<center><section class="navigation" style="cursor: pointer;color: #f37e09;margin: 0px 4px 0 0;font-weight: bold;">
			<span id="countdown" class="timer" style="font-size: 14px"></span></section></center>
		</div>
	</div>
</div>
<div class="col-md-7">
