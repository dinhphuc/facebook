<div class="col-md-5 ">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Auto Like - Tăng Lượt Like Tự Động</h4>
			
		</div>
		<div class="box-body">
			<h4><strong><p class="text-danger"> Hệ Thống Tăng Like Facebook Theo ID Bất Kỳ</p></strong></h4>
			...
			<font style="color:#23c6c8;">Bước 2:</font> Nhập ID Vào Khung Bên Dưới Sau Đó Thực Hiện Auto Like. <br />
			...
			<div class="form-group">
				<label for="name">Chọn Số Lượng Like - Kéo Thanh Trượt Để Điều Chỉnh</label>
				<center>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="like" onclick="post_Like();">
					<i class="fa fa-exchange"></i> Auto Like
				</button>
			</div>
		</div>
