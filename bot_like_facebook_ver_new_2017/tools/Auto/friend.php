<div class="col-md-12">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-user-plus"></i> Auto Add Friends - Tăng Lượt Kết Bạn Tự Động</h4>
			
		</div>
		<div class="box-body">
			<h4><strong><p class="text-danger"> Hệ Thống Tăng Lượt Kết Bạn Facebook Theo ID Bất Kỳ</p></strong></h4>
			...
			<div class="form-group">
				<label for="name">Chọn Số Lượng Lời Mời Kết Bạn - Kéo Thanh Trượt Để Điều Chỉnh</label>
				<center>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="friend" onclick="post_Friend();">
					<i class="fa fa-exchange"></i> Auto Kết Bạn
				</button>
			</div>
		</div>
