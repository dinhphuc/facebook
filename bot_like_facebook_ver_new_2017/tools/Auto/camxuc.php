<div class="col-md-5">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Auto Reactions - Tăng Lượt Cảm Xúc Tự Động</h4>
			
		</div>
		<div class="box-body">
			<h4><strong><p class="text-danger"> Hệ Thống Tăng Cảm Xúc Facebook Theo ID Bất Kỳ</p></strong></h4>
			...
			<font style="color:#23c6c8;">Bước 2:</font> Nhập ID Vào Khung Bên Dưới Sau Đó Thực Hiện Auto Cảm Xúc. <br />
			...
			<div class="form-group red">
				<label for="name">Chọn Số Lượng Cảm Xúc - Kéo Thanh Trượt Để Điều Chỉnh</label>
				<center>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="camxuc" onclick="post_CamXuc();">
					<i class="fa fa-exchange"></i> Auto Cảm Xúc
				</button>
			</div>
		</div>
