<div class="col-md-5">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Auto UnFriends</h4>
			
		</div>
		<div class="box-body">
			<h4><strong><p class="text-danger"> Hệ Thống Tự Động UnFriends Bất Kỳ</p></strong></h4>
			...
			<font style="color:#23c6c8;">Bước 1:</font> Sử Dụng Mục Bên "Danh Sách Bạn Bè" Để Chọn ID Friends Của Bạn.Sau Đó Thực Hiện Auto Unfriends. <br />
			<hr>
...
if( isset($_POST['id']) && is_array($_POST['id']) ) {
  foreach($_POST['id'] as $lol) {
	auto('https://graph.facebook.com/me/friends?uid='.$lol.'&access_token='.$_SESSION['matoken'].'&method=delete').'';
          $c++;
   }
echo '<div class="alert alert-info"> SUCCESS: Auto UnFriends Thành Công.<br /> Đã Xóa '.$c.' Friends .<script type="text/javascript">toarst("success","Auto UnFriends Thành Công!.","Lời Nhắn Từ Hệ Thống")</script></div>';
}
