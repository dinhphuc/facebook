<div class="col-md-5">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Auto Poke Friends - Hệ Thống Tự Động Chọc Friends</h4>
...
if( isset($_POST['id']) && is_array($_POST['id']) ) {
  foreach($_POST['id'] as $lol) {
	auto('https://graph.facebook.com/'.$lol.'/pokes?&access_token='.$_SESSION['matoken'].'&method=post').'';
          $c++;
   }
