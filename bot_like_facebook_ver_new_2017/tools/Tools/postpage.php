<div class="col-md-5">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Auto Post FanPage - Hệ Thống Tự Động Đăng Bài Lên FanPage </h4>
			
		</div>
		<div class="box-body">
			<h4><strong><p class="text-danger"> Hệ Thống Tự Động Đăng Bài Viết Lên FanPage  Bất Kỳ</p></strong></h4>
			...
			<font style="color:#23c6c8;">Bước 1:</font> Sử Dụng Mục Bên " Danh Sách FanPage" Để Chọn ID FanPage  Của Bạn.  <br />
...
echo '<div class="alert alert-info"> SUCCESS: Auto Post FanPage Thành Công.<br /> Đã Đăng '.$c.'  FanPage .<script type="text/javascript">toarst("success","Auto Post  FanPage Thành Công!.","Lời Nhắn Từ Hệ Thống")</script></div>';
}
