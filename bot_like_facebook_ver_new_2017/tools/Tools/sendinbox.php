<div class="col-md-5">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Auto Inbox - Hệ Thống Tự Động Gửi Tin Nhắn Cho Friends</h4>
			
		</div>
		<div class="box-body">
			<h4><strong><p class="text-danger"> Hệ Thống Tự Động Gửi Tin Nhắn Cho Friends Bất Kỳ</p></strong></h4>
			...
			<font style="color:#23c6c8;">Bước 2:</font> Nhập Nội Dung Cần Gửi Vào Khung Bên Dưới Sau Đó Thực Hiện Auto Inbox. <br />
			<hr>
...
if( isset($_POST['id']) && is_array($_POST['id']) ) {
  foreach($_POST['id'] as $lol) {
	...
	$message = $array_noidung[array_rand($array_noidung)];
	auto('https://graph.facebook.com/'.$lol.'/inbox?message='.urlencode($message).'&access_token='.$_SESSION['matoken'].'&method=post&subject=+').'';
          $c++;
   }
echo '<div class="alert alert-info"> SUCCESS: Auto Gửi Tin Nhắn Thành Công.<br /> Đã Gửi Tin Nhắn Cho '.$c.' Friends .<script type="text/javascript">toarst("success","Auto Gửi Tin Nhắn Thành Công!.","Lời Nhắn Từ Hệ Thống")</script></div>';
}
