<div class="col-md-5">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Boom Comment - Bão Comment Trang Cá Nhân</h4>
			
		</div>
		<div class="box-body">
			<h4><strong><p class="text-danger"> Hệ Thống Bão Comment Trang Cá Nhân Theo ID Bất Kỳ</p></strong></h4>
			<font style="color:#23c6c8;">Bước 1:</font> Sử Dụng Mục Bên " Danh Sách Bạn Bè" Để Copy ID Bạn Bè Của Bạn.  <br />
			<font style="color:#23c6c8;">Bước 2:</font> Nhập ID Vào Khung Bên Dưới Sau Đó Thực Hiện Boom Comment. <br />
			<font style="color:#ed5565;">Lưu Ý: Hệ Thống Sẽ Tự Động GET Các Status Mới Nhất Của Người Bạn Cần Bão Comment. Để Comment Trên Đó Nên Các Bạn Phải Nhập ID Trang Cá Nhân. </font>
			<hr>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="boomcmt" onclick="post_BoomCmt();">
