...
if(preg_match('#name=\\"fb_dtsg\\" value=\\"(.*?)\\"#is', $data, $fb_dtsg)){
	$result_token = cURL('https://www.facebook.com/v2.7/dialog/oauth/confirm', true, 'fb_dtsg='.$fb_dtsg[1].'&app_id=165907476854626&redirect_uri=fbconnect://success&display=popup&access_token=&sdk=&from_post=1&private=&tos=&login=&read=&write=&extended=&social_confirm=&confirm=&seen_scopes=&auth_type=&auth_token=&auth_nonce=&default_audience=&ref=Default&return_format=access_token&domain=&sso_device=ios&__CONFIRM__=1');
